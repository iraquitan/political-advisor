# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2017-01-27 17:11
...
import political_advisor.models.models
import uuid
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('SU', 'Super User'), ('AU', 'Assessor User')], default='SU', max_length=2)),
                ...
                ('super_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='assessors', to=settings.AUTH_USER_MODEL)),
            ...
            managers=[
                ('objects', political_advisor.models.models.CustomUserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Address',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('gender', models.CharField(choices=[('U', 'Undefined'), ('M', 'Male'), ('F', 'Female')], max_length=2)),
